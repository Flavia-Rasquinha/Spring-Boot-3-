...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaDataCenario1() {
        ...
        cadastrarConsulta(medico, paciente, proximaSegundaAs10, Especialidade.ORTOPEDIA);
    ...
    private void cadastrarConsulta(Medico medico, Paciente paciente, LocalDateTime data, Especialidade especialidade) {
        em.persist(new Consulta(medico, paciente, data, especialidade, null));
    }
